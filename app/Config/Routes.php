...
$routes->group('5', ['namespace' => 'App\Controllers\Manager'], ['fiter' => 'CheckSession'], function ($routes) {
  
  require(__DIR__ . "/_extend_routes/manager.php");
  // // sidebar menu dashboard
});

$routes->group('6', ['namespace' => 'App\Controllers\Finance'], ['fiter' => 'CheckSession'], function ($routes) {
  
  require(__DIR__ . "/_extend_routes/Finance.php");
  // // sidebar menu dashboard
});

$routes->group('7', ['namespace' => 'App\Controllers\Officer'], ['fiter' => 'CheckSession'], function ($routes) {
  
  require(__DIR__ . "/_extend_routes/officer.php");
  // // sidebar menu dashboard
});