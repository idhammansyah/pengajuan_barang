...
abstract class BaseController extends Controller
{
  ...
  protected $request;
	...
	protected $users, $log_activity, $token, $session, $validation, $menu, $sub_menu, $role, $calendar_events, $materials, $company, $department, $level, $location, $position, $contract, $jobs, $purchasing;
